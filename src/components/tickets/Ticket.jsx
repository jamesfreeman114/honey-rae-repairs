...
export const Ticket = ({ ticket, currentUser, getAndSetTickets }) => {
    ...
    return (<section className="ticket">
        ...
        <footer>
            ...
            <div className="btn-container" onClick={(handleClaim)}>
            ...
            {/* If the logged in user is the assigned employee for a ticket and there is no dateCompleted then a button to close the ticket should display */}
